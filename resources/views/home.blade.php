...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="/manual">Charts</a>
          </li>
        </ul>
      </div>
    </nav>
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
        <h1 class="mb-0">(UFT)
            <span class="text-primary">United Front for Transformation</span>
          </h1>
          <div class="subheading mb-5">Makerere University· Kabenge, CO 80810 · (317) 585-8468 ·
            <a href="mailto:lubwama73@gmail.com">lubwama73@email.com</a>
          </div>
          <p class="mb-5">United Front for Transformation (UFT) is a new political party, which was recently formed and registered in Uganda. The party is currently using agents to enroll new members across the country.Whoever is enrolled by an agent, becomes a member of the party. An enrolled member may be upgraded to an agent by the system’s administrator via a web interface.  </p>
